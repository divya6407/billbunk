          ...
          <div className='flex flex-col justify-center items-center h-screen font-serif text-[#384b62]'>
              <div className='shadow-xl p-5 rounded-md bg-white'>
                  ...
                  <form onSubmit={handleSubmit} className='flex justify-center flex-col '>
                      ...
                      <button className="bg-[#2a949b] rounded-md p-2 text-white mb-4 shadow" type='submit' disabled={loading}>{loading ? 'Logging in...' : 'Login'}</button>
                  </form>
                  <div className='text-center'>No account? <Link to="/register">Register Here</Link></div>
              </div>
          </div>
      </div>
  );
